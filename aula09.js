import './styles.css'
import * as THREE from '/builds/three.js';
...
const canvas = document.querySelector('#bg4');
...
loader.load('./3d/AULA_09.glb', function(glft){
  glft.scene.position.x = 19.375;
  glft.scene.position.z = 60;
